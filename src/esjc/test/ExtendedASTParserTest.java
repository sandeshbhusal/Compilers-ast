...
import esjc.util.Diff;
import esjc.util.DiffPrint;
...
public class ExtendedASTParserTest {
  ...
  private static Pair<String, CompilationUnit> parse(final String filename)
    ...
    return new Pair<>(System.getProperty("user.dir") + "/resources/" + filename + ".ast",
  ...
  private static void testPass(final String filename) {
    ...
    try {
      ...
      final String result = cu.toString();
      {
        ...
        final FileReader fr = new FileReader(p.first);
